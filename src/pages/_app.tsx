  ...
  return (
    <Fragment>
      <Head>
        ...
        />
        <title key="title">ViralCoin</title>
        ...
        <meta name="application-name" content="ViralCoin App" />
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" />
        <meta name="apple-mobile-web-app-title" content="ViralCoin App" />

        <meta name="format-detection" content="telephone=no" />
        <meta name="mobile-web-app-capable" content="yes" />
        <meta name="msapplication-config" content="/browserconfig.xml" />
        <meta name="msapplication-tap-highlight" content="no" />
        <meta name="theme-color" content="#460cf0" />

        <meta key="twitter:card" name="twitter:card" content="app" />
        <meta key="twitter:title" name="twitter:title" content="ViralCoin App" />
        <meta key="twitter:url" name="twitter:url" content={domainURL} />
        <meta
        ...
        <meta
          key="twitter:image"
          name="twitter:image"
          content={domainURL + '/icons/icon-192x192.png'}
        />
        <meta key="twitter:creator" name="twitter:creator" content="@SushiSwap" />
        <meta property="og:title" content="Let's Go Viral Together!" />
        <meta property="og:site_name" content="ViralCoin" />
        <meta property="og:url" content={domainURL} />
        <meta
          property="og:description"
          content="ViralCoin is taking over to become the largest, multi-network crypto ever. Learn more now how you can be involved easily with no purchase necessary."
        />
        <meta property="og:type" content="website" />
        <meta property="og:image" content={domainURL + '/images/img.png'} />
        <meta
          key="og:description"
          property="og:description"
          content="Be a DeFi Chef with Sushi. Swap, earn, stack yields, lend, borrow, leverage all on one decentralized, community driven platform. Welcome home to DeFi"
