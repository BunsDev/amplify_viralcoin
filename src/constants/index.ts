...
export const mobileconnector = new TorusConnector({
  chainId: 1
})

export const RPC = {
  [ChainId.MAINNET]: 'https://eth-mainnet.alchemyapi.io/v2/SCqxqFXhrBZa0SAqEKXH-m4yd376e_wf',
...
export const SUPPORTED_WALLETS: { [key: string]: WalletInfo } = {
  ...
  METAMASK_MOBILE_CONNECT: {
    connector: mobileconnector,
    name: 'MetaMask Mobile',
    iconName: 'metamask.png',
    description: 'Use Metamask app on mobile device.',
    href: null,
    color: '#E8831D',
    mobile: true
  }
